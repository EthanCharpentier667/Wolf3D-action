...
const struct enemy_infos_s ENEMY_INFOS[] = {
    ...
    {RES "enemy.png", {2.5, 2.5}, {768 + 32, 1920 + 32, -0.90},
        {0, 0, 65, 65}, 0.5, 100, 150, 300, 10, 1, "Key", BASIC},
...
const struct env_infos_s ENVIRONNEMENT_INFOS[] = {
    ...
    {RES "blue_door.png", {0, 0, 0, 0}, {1, 1}, false, false, true, 5},
