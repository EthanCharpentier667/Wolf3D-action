...
const struct enemy_infos_s ENEMY_INFOS[] = {
    {RES "enemy.png", {2.5, 2.5}, {320, 384, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, "Ammo_box", BASIC},
    {RES "enemy.png", {2.5, 2.5}, {128 + 32, 320 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, NULL, BASIC},
    {RES "enemy.png", {2.5, 2.5}, {256 + 32, 512 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, NULL, BASIC},
    {RES "enemy.png", {2.5, 2.5}, {512 + 32, 512 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, "Heal", BASIC},
    {RES "enemy.png", {2.5, 2.5}, {640 + 32, 512 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, NULL, BASIC},
    {RES "enemy2.png", {2.5, 2.5}, {640 + 32, 832 + 32, -0.90},
        {0, 0, 65, 65}, 1, 150, 250, 500, 10, 1, "Heal", BASIC},
    {RES "enemy.png", {2.5, 2.5}, {704 + 32, 576 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, NULL, BASIC},
    {RES "enemy2.png", {2.5, 2.5}, {256 + 32, 768 + 32, -0.90},
        {0, 0, 65, 65}, 1, 150, 250, 500, 10, 1, "Key", BASIC},
    {RES "enemy.png", {2.5, 2.5}, {896 + 32, 64 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, NULL, BASIC},
    {RES "enemy2.png", {2.5, 2.5}, {896 + 32, 256 + 32, -0.90},
        {0, 0, 65, 65}, 1, 150, 250, 500, 10, 1, "Key", BASIC},
    {RES "enemy.png", {2.5, 2.5}, {1344 + 32, 128 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, NULL, BASIC},
    {RES "enemy.png", {2.5, 2.5}, {1536 + 32, 128 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, NULL, BASIC},
    {RES "enemy.png", {2.5, 2.5}, {1920 + 32, 640 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, "Heal", BASIC},
    {RES "enemy.png", {2.5, 2.5}, {1664 + 32, 896 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, NULL, BASIC},
    {RES "enemy.png", {2.5, 2.5}, {1408 + 32, 704 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, NULL, BASIC},
    {RES "enemy.png", {2.5, 2.5}, {1280 + 32, 512 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, "Key", BASIC},
    {RES "enemy.png", {2.5, 2.5}, {1088 + 32, 896 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, NULL, BASIC},
    {RES "enemy.png", {2.5, 2.5}, {1216 + 32, 1344 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, NULL, BASIC},
    {RES "enemy.png", {2.5, 2.5}, {1536 + 32, 1280 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, "Heal", BASIC},
    {RES "enemy.png", {2.5, 2.5}, {1856 + 32, 1152 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, NULL, BASIC},
    ...
    {RES "enemy.png", {2.5, 2.5}, {1536 + 32, 640 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, "Ammo_box", BASIC},
    {RES "enemy.png", {2.5, 2.5}, {1536 + 32, 1792 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, NULL, BASIC},
    {RES "enemy.png", {2.5, 2.5}, {768 + 32, 1920 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, "Key", BASIC},
    {RES "enemy.png", {2.5, 2.5}, {512 + 32, 1856 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, NULL, BASIC},
    {RES "enemy.png", {2.5, 2.5}, {896 + 32, 1728 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, "Heal", BASIC},
    {RES "enemy.png", {2.5, 2.5}, {1088 + 32, 1088 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, "Key", BASIC},
    {RES "enemy.png", {2.5, 2.5}, {64 + 32, 1856 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, NULL, BASIC},
    {RES "enemy.png", {2.5, 2.5}, {256 + 32, 1920 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, "Ammo_box", BASIC},
    {RES "enemy.png", {2.5, 2.5}, {832 + 32, 1472 + 32, -0.90},
        {0, 0, 65, 65}, 1, 100, 250, 500, 10, 1, "Ammo_box", BASIC},
    {RES "Hitler1.png", {2.5, 2.5}, {256 + 32, 1088 + 32, -0.90},
        {0, 0, 74, 72}, 1, 400, 100, 500, 20, 0.5f, NULL, HITLER},
